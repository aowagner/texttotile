...
UI kontrol med Style. Eg. fill bg. (to Styles page?)
Also on/off tagblocks here?

Use of real css, and explanation of 'substitutions': # -> .   and @ -> --

Also Settings popup here.

Also metadata on individual lines here?

Ctrl+Tab to jump between pinned files, etc.
